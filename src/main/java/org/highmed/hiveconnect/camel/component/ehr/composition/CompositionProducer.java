...
public class CompositionProducer extends DefaultProducer {
    ...
    private void mergeCanonicalCompositionEntity(UUID ehrId, Exchange exchange) {
        ...
        //if yes: post and return the mergedCompositions versionUid
        //else put and return the mergedCompositions versionUid
        Composition mergedComposition = ((HIVEconnectRestCompositionEndpoint)(endpoint.getOpenEhrClient().compositionEndpoint(ehrId))).mergeCanonicalCompositionEntity(body);
