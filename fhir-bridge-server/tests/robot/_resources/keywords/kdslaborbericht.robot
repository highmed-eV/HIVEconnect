...
validate content response_aql - 201
    ...
    Should Be Equal As Strings    ${template_id}[0]    KDS_Laborbericht

create fhir bundle
    [Arguments]         ${text}    ${example_json}
    POST /KDSLaborberichtBundle with ehr reference    ${text}    ${example_json}


POST /KDSLaborberichtBundle with ehr reference
...
create openehr aql
    ...
    POST /KDSLaborberichtBundleAQL with ehr reference    ${openehr_template}

POST /KDSLaborberichtBundleAQL with ehr reference
    [Arguments]         ${openehr_template}
