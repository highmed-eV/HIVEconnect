...
create openehr aql
    ...
    POST /KDSPersonBundleAQL with ehr reference    ${openehr_template}

POST /KDSPersonBundleAQL with ehr reference
    [Arguments]         ${openehr_template}
...
#                        Output Debug Info To Console
    ...
    &{resp_ehr}=    Load JSON From File    ${EHR_COMPOSITION}/kds_person_canonical.json
