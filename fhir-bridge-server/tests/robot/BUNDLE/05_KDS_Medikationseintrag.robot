...
001 Create KDS Medikationseintrag FHIR Bundle
    [Documentation]         1. *CREATE* new EHR record\n\n
        ...                 2. *CREATE* FHIR bundle kds_medikationseintrag_bundle.json and post it to FHIR server\n\n
    ...
    [Tags]             	kds-medikationseintrag-fhir-bundle    valid   not-ready    not-implemented
