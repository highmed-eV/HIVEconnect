...
001 Create KDS Laborbericht FHIR Bundle
    [Documentation]         1. *CREATE* new EHR record\n\n
        ...                 2. *CREATE* FHIR bundle kds_laborbericht_bundle.json and post it to FHIR server\n\n
    ...
    [Tags]             	kds-laborbericht-fhir-bundle    valid   not-ready    not-implemented
