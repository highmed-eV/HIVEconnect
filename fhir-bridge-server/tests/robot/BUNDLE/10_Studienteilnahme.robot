...
*** Test Cases ***
001 Create Studienteilnahme FHIR Bundle
    [Documentation]         1. *CREATE* new EHR record\n\n
        ...                 2. *CREATE* FHIR bundle studienteilnahme_bundle.json and post it to FHIR server\n\n
    ...
    [Tags]             	studienteilnahme-fhir-bundle    valid   not-ready    not-implemented
