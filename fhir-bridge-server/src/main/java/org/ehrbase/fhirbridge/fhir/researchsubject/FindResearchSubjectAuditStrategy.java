 ...
 * @since 1.0.0
 */
public class FindResearchSubjectAuditStrategy extends FhirQueryAuditStrategy {

    public FindResearchSubjectAuditStrategy() {
    ...
    public AuditMessage[] makeAuditMessage(AuditContext auditContext, FhirQueryAuditDataset auditDataset) {
        return new QueryInformationBuilder<>(auditContext, auditDataset, FhirBridgeEventType.FIND_RESEARCH_SUBJECT)
