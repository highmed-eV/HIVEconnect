 ...
 * @since 1.0.0
 */
public class FindServiceRequestAuditStrategy extends FhirQueryAuditStrategy {

    public FindServiceRequestAuditStrategy() {
    ...
    public AuditMessage[] makeAuditMessage(AuditContext auditContext, FhirQueryAuditDataset auditDataset) {
        return new QueryInformationBuilder<>(auditContext, auditDataset, FhirBridgeEventType.FIND_SERVICE_REQUEST)
