 ...
 * @since 1.0.0
 */
public class FindListResourceAuditStrategy extends FhirQueryAuditStrategy {

    public FindListResourceAuditStrategy() {
    ...
    public AuditMessage[] makeAuditMessage(AuditContext auditContext, FhirQueryAuditDataset auditDataset) {
        return new QueryInformationBuilder<>(auditContext, auditDataset, FhirBridgeEventType.FIND_LIST_RESOURCE)
