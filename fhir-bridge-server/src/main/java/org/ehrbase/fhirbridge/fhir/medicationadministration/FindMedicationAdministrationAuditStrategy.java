 ...
 * @since 1.0.0
 */
public class FindMedicationAdministrationAuditStrategy extends FhirQueryAuditStrategy {

    public FindMedicationAdministrationAuditStrategy() {
    ...
    public AuditMessage[] makeAuditMessage(AuditContext auditContext, FhirQueryAuditDataset auditDataset) {
        return new QueryInformationBuilder<>(auditContext, auditDataset, FhirBridgeEventType.FIND_MEDICATION_ADMINISTRATION)
