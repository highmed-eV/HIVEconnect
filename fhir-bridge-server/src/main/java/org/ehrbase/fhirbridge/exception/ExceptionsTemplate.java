...
public class ExceptionsTemplate {
    public static final String AN_IO_EXCEPTION_OCCURED_WHILE_LOADING_CUSTOM_PROFILES = "An I/O exception occurred while loading custom profiles";
    public static final String AN_IO_EXCEPTION_OCCURED_DURING_INITIALIZATION = "An I/O exception occurred during initialization";
    public static final String AN_ERROR_OCCURRED_WHILE_PARSING_TEMPLATE = "An error occurred while parsing template [%s]";


    private static final Map<String, ExceptionDto> errorMap = new HashMap<>();
