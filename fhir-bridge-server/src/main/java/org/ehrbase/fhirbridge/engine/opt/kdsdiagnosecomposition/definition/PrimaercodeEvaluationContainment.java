...
public class PrimaercodeEvaluationContainment extends Containment {
  ...
  public SelectAqlField<KlinischerStatusCluster> KLINISCHER_STATUS = new AqlFieldImp<KlinischerStatusCluster>(PrimaercodeEvaluation.class, "/data[at0001]/items[openEHR-EHR-CLUSTER.problem_qualifier.v2]", "klinischerStatus", KlinischerStatusCluster.class, this);

  public SelectAqlField<DvCodedText> DIAGNOSESICHERHEIT = new AqlFieldImp<DvCodedText>(PrimaercodeEvaluation.class, "/data[at0001]/items[at0073]/value", "diagnosesicherheit", DvCodedText.class, this);
  ...
  public SelectAqlField<PrimaercodeSchweregradNullFlavourChoice> SCHWEREGRAD_NULL_FLAVOUR = new AqlFieldImp<PrimaercodeSchweregradNullFlavourChoice>(PrimaercodeEvaluation.class, "/data[at0001]/items[at0005]/null_flavour", "schweregradNullFlavour", PrimaercodeSchweregradNullFlavourChoice.class, this);

  public SelectAqlField<PrimaercodeSchweregradChoice> SCHWEREGRAD = new AqlFieldImp<PrimaercodeSchweregradChoice>(PrimaercodeEvaluation.class, "/data[at0001]/items[at0005]/value", "schweregrad", PrimaercodeSchweregradChoice.class, this);
